...
botaoAlterarTema.addEventListener("click", () => {
  ...
  if (modoEscuroEstaAtivo) {
    imagemBotaoTrocaDeTema.setAttribute("src", "./src/imagens/carinha-kumon-preto.png");
  } else {
    imagemBotaoTrocaDeTema.setAttribute("src", "./src/imagens/carinha-kumon-branca.png");
  }
});